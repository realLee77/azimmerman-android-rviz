...
public class Arrow extends BaseShape {
	...
	private static int coneStripTriangleCount;
	private static int coneFanTriangleCount;

	private static FloatBuffer coneSideVerticesBuf;
	private static FloatBuffer coneSideNormalsBuf;

	private static FloatBuffer coneBottomVerticesBuf;
	private static FloatBuffer coneBottomNormalsBuf;

	static {
		int sides = 17;
		float CONE_Z_OFFSET = 1f;
		float CONE_RADIUS = 0.05f;
		float CONE_HEIGHT = 0.3f;
	...
	private static int cylStripTriangleCount;
	private static int cylFanTriangleCount;
	private static FloatBuffer cylSideVerticesBuf;
	private static FloatBuffer cylSideNormalsBuf;
	private static FloatBuffer cylBottomVerticesBuf;
	private static FloatBuffer cylBottomNormalsBuf;

	static {
		int sides = 17;
		float CYL_HEIGHT = 1f;
		float CYL_Z_OFFSET = 0.0f;
		float CYL_RADIUS = 0.025f;
		double dTheta = TWO_PI / sides;
