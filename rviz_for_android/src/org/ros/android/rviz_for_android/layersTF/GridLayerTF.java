...
import org.ros.android.rviz_for_android.vis.TfLayerTF;
...
public class GridLayerTF extends DefaultLayerTF implements LayerWithPropertiesTF, TfLayerTF {
	...
	public GridLayerTF(int cells, float spacing) {
		super();

		prop = new BoolProperty("enabled", true, null);
		prop.addSubProperty(new TfFrameProperty("Parent", null, null, null));
	...
	public void onStart(ConnectedNode connectedNode, Handler handler, TransformTree transformTree, Camera camera) {
		prop.<TfFrameProperty>getProperty("Parent").setTransformTree(transformTree);
	}
	...
	public String getFrame() {
		return prop.<TfFrameProperty> getProperty("Parent").getValue();
	}
