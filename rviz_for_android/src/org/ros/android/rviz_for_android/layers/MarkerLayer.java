...
public class MarkerLayer extends EditableStatusSubscriberLayer<visualization_msgs.Marker> implements LayerWithProperties {
	...
	private static class MarkerObj {
		...
		public MarkerObj(Marker msg, Camera cam) {
			...
			Transform shapeTrans = Transform.newFromPoseMessage(msg.getPose());
			Log.i("MarkerLayer", "Shape transform: " + shapeTrans);
			Log.i("MarkerLayer", "Shape scale: " + Arrays.toString(scale));
			Log.i("MarkerLayer", "Shape duration: " + duration + " expires at " + endTime);
